  ...
  return (
    <div className={css.Interested}>
      ...
      onClick={() => setPosition({ ...position, info1: { x: 0, y: 0 }}) } >
        ...
        <div className={css.CardInfo} style={{ left: info1.x, top: info1.y }} onMouseLeave={() => setPosition({ ...position, info1: { x: 50, y: 185 }})}>
      ...
      onClick={() => setPosition({ ...position, info2: { x: 0, y: 0 }})} >
        ...
        <div className={css.CardInfo} style={{ left: info2.x, top: info2.y }} onMouseLeave={() => setPosition({ ...position, info2: { x: 50, y: 185 }})}>
      ...
      onClick={() => setPosition({ ...position, info3: { x: 0, y: 0 }})} >
        ...
        <div className={css.CardInfo} style={{ left: info3.x, top: info3.y }} onMouseLeave={() => setPosition({ ...position, info3: { x: 50, y: 185 }})}>
      ...
      onClick={() => setPosition({ ...position, info4: { x: 0, y: 0 }})} >
        ...
        <div className={css.CardInfo} style={{ left: info4.x, top: info4.y }} onMouseLeave={() => setPosition({ ...position, info4: { x: 50, y: 185 }})}>
      ...
      onClick={() => setPosition({ ...position, info5: { x: 0, y: 0 }})} >
        ...
        <div className={css.CardInfo} style={{ left: info5.x, top: info5.y }} onMouseLeave={() => setPosition({ ...position, info5: { x: 50, y: 185 }})}>
      ...
      onClick={() => setPosition({ ...position, info6: { x: 0, y: 0 }})} >
        ...
        <div className={css.CardInfo} style={{ left: info6.x, top: info6.y }} onMouseLeave={() => setPosition({ ...position, info6: { x: 50, y: 185 }})}>
